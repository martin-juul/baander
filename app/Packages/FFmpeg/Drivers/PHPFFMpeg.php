...
use App\Packages\FFmpeg\FFMpeg\{AdvancedMedia, AudioMedia, FFProbe, VideoMedia};
use App\Packages\FFmpeg\Filesystem\MediaCollection;
...
class PHPFFMpeg
{
    ...
    /**
     * @var \App\Packages\FFmpeg\Filesystem\MediaCollection
     */
