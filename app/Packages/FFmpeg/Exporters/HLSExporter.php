...
use App\Packages\FFmpeg\Filesystem\{Disk, Media};
...
class HLSExporter extends MediaExporter
{
    ...
    /**
     * @var \App\Packages\FFmpeg\Exporters\PlaylistGenerator
     */
     ...
     *
     * @param \App\Packages\FFmpeg\Exporters\PlaylistGenerator $playlistGenerator
     * @return self
     */
     ...
     * @param \App\Packages\FFmpeg\Filesystem\Disk $disk
     * @param integer $key
     * @return array
     */
     ...
     *
     * @param \App\Packages\FFmpeg\Filesystem\Media $media
     * @return self
     */
     ...
     * @throws \App\Packages\FFmpeg\Exporters\NoFormatException
     */
     ...
     *
     * @param string $path
     * @return \App\Packages\FFmpeg\MediaOpener
     */
