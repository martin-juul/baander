...
use App\Packages\FFmpeg\FFMpeg\{NullFormat, StdListener};
use App\Packages\FFmpeg\Filesystem\{Disk, Media};
use App\Packages\FFmpeg\Filters\TileFactory;
use App\Packages\FFmpeg\MediaOpener;
use App\Packages\FFmpeg\Support\ProcessOutput;

/**
 * @mixin \App\Packages\FFmpeg\Drivers\PHPFFMpeg
 */
class MediaExporter
{
    ...
    /**
     * @var \App\Packages\FFmpeg\Drivers\PHPFFMpeg
     */
    protected $driver;
    ...
    /**
     * @var \App\Packages\FFmpeg\Filesystem\Disk
     */
    private $toDisk;
