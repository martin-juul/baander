...
final class Zend_Media_Id3v2 extends Zend_Media_Id3_Object
{
    ...
    public function getFrameByIdentifier($identifier)
    {
        $frames = $this->getFramesByIdentifier($identifier);
    ...
    public function getApicFrame(): Zend_Media_Id3_Frame_Apic|null
    {
        return $this->getFrameByIdentifier('APIC');
    }

    public function getTconFrame(): Zend_Media_Id3_Frame_Tcon|null
    {
        return $this->getFrameByIdentifier('TCON');
    }

    public function getTpe1Frame(): Zend_Media_Id3_Frame_Tpe1|null
    {
        return $this->getFrameByIdentifier('TPE1');
    }

    public function getTpe2Frame(): Zend_Media_Id3_Frame_Tpe2|null
    {
        return $this->getFrameByIdentifier('TPE2');
    }

    public function getTpe3Frame(): Zend_Media_Id3_Frame_Tpe3|null
    {
        return $this->getFrameByIdentifier('TPE3');
    }

    public function getTpubFrame(): Zend_Media_Id3_Frame_Tpub|null
    {
        return $this->getFrameByIdentifier('TPUB');
    }

    public function getTIT2Frame(): Zend_Media_Id3_Frame_Tit2|null
    {
        return $this->getFrameByIdentifier('TIT2');
    }
