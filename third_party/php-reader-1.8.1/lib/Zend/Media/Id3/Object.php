...
abstract class Zend_Media_Id3_Object
{
    ...
    protected final function _translateIntToEncoding($encoding)
    {
        ...
        if (is_integer($encoding)) {
            return match ($encoding) {
                Zend_Media_Id3_Encoding::UTF16 => 'utf-16',
                Zend_Media_Id3_Encoding::UTF16LE => 'utf-16le',
                Zend_Media_Id3_Encoding::UTF16BE => 'utf-16be',
                Zend_Media_Id3_Encoding::ISO88591 => 'iso-8859-1',
                default => 'utf-8',
            };
        }
    }
    ...
    protected final function _translateEncodingToInt($encoding)
    {
        ...
        if (is_string($encoding)) {
            return match ($encoding) {
                'utf-16' => Zend_Media_Id3_Encoding::UTF16,
                'utf-16le' => Zend_Media_Id3_Encoding::UTF16,
                'utf-16be' => Zend_Media_Id3_Encoding::UTF16BE,
                'iso-8859-1' => Zend_Media_Id3_Encoding::ISO88591,
